...
command = f"CUDA_VISIBLE_DEVICES={cuda_device} python train.py -s {data}\
            -m /mnt/ws-frb/users/frank/frank/gaussian_splatting/{folder_path}/ds_fovmask --single_frame_id {frame_ids}\
...
command = f"CUDA_VISIBLE_DEVICES={cuda_device} python train.py -s {data}\
            -m /mnt/ws-frb/users/frank/frank/gaussian_splatting/{folder_path}/dist_loss --single_frame_id {frame_ids}\
...
command = f"CUDA_VISIBLE_DEVICES={cuda_device} python train.py -s {data}\
            -m /mnt/ws-frb/users/frank/frank/gaussian_splatting/{folder_path}/ds_reset_opa_fovmask --single_frame_id {frame_ids}\
...
# Ours
command = f"CUDA_VISIBLE_DEVICES={cuda_device} python train.py -s {data}\
            -m /mnt/ws-frb/users/frank/frank/gaussian_splatting/{folder_path}/SAD_GS --single_frame_id {frame_ids}\
